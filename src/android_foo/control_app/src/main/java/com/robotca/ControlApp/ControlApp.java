...
public class ControlApp extends RosActivity implements ListView.OnItemClickListener,
    ...
    public static final String NOTIFICATION_TITLE = "JARVIS";
...
//    private static LaserScanMap laserScanMap;
    ...
    private static final String CONTROL_SERVO_MODE_BUNDLE_ID = "com.robotca.Views.Fragments.ServoFragment.controlMode";
...
//        editor.putBoolean(getString(R.string.prefs_warning_beep_key), true);
        ...
        if (getActionBar() != null) {
            ...
            actionBar.setDisplayHomeAsUpEnabled(true);  // If display bar icon
            actionBar.setHomeButtonEnabled(true);
            actionBar.setDisplayShowHomeEnabled(false);  // If display app icon
...
//    }
    ...
    private void selectItem(int position) {
        ...
        if (servoFragment != null && getControlMode().ordinal() <= ControlMode.Tilt.ordinal()) {
            servoFragment.show();
        }
...
//     */
//    public ControlMode getControlMode() {
//        return servoFragment.getControlMode();
//    }
